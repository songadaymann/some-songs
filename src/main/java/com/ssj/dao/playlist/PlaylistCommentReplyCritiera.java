 ...
 * @version $Id$
 */
public class PlaylistCommentReplyCritiera extends SearchCriteria<PlaylistCommentReplySearch> {
  protected void populateCriteria(List<Criterion> criteriaList) {
    PlaylistCommentReplySearch search = getSearch();
...
//    getFetchModes().put("originalComment.playlist", FetchMode.JOIN);
