...
public class RelatedArtistsController {
  ...
  private String viewName = "include/related_artists";

  private ArtistService artistService;

  @RequestMapping("/include/related_artists")
  protected ModelAndView handleRequestInternal(@RequestParam("id") int artistId) {
    ...
    return new ModelAndView(getViewName(), "relatedArtists", artist.getRelatedArtists());
  }
