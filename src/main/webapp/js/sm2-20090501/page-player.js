...
function PagePlayer(oConfigOverride) {
  ...
  this.handleClick = function(e) {
    ...
    if (thisSound) {
      ...
      // find parent li, don't assume it's the direct parent - sam
      var oParentNode = self.getParentByNodeName(o, 'li');
      oParentNode.appendChild(oControls);
      oParentNode.appendChild(document.getElementById('spectrum-container'));
      self.soundsByObject[o.rel] = thisSound;
      // tack on some custom data
      thisSound._data = {
        oLink: o, // DOM reference within SM2 object event handlers
        oLI: oParentNode,
        oControls: self.getElementsByClassName('controls','div',oParentNode)[0],
        oStatus: self.getElementsByClassName('statusbar','div',oParentNode)[0],
        oLoading: self.getElementsByClassName('loading','div',oParentNode)[0],
        oPosition: self.getElementsByClassName('position','div',oParentNode)[0],
        oTimingBox: self.getElementsByClassName('timing','div',oParentNode)[0],
        oTiming: self.getElementsByClassName('timing','div',oParentNode)[0].getElementsByTagName('div')[0],
        oPeak: self.getElementsByClassName('peak','div',oParentNode)[0],
        oGraph: self.getElementsByClassName('spectrum-box','div',oParentNode)[0],
