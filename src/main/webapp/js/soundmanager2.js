...
function SoundManager(smURL,smID) {
  ...
  this.nullURL = 'js/null.mp3';  // path to "null" (empty) MP3 file, used to unload sounds (Flash 8 only)
  ...
  this._normalizeMovieURL = function(smURL) {
    ...
    return(smURL && smURL.lastIndexOf('/')!=-1?smURL.substr(0,smURL.lastIndexOf('/')+1):'./js/')+_s.movieURL;
  };
