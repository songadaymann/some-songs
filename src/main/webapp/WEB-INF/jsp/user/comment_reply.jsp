        ...
        <div class="yui-b"><div class="yui-g">
          ...
          <div class="originalComment">
            <div class="songCommentsHeader">
              ...
              <span class="smallBoldLink"><a href="<c:out value="/songs/${song.titleForUrl}-${song.id}"/>">[Show All Comments]</a></span>
              </c:if>
            </div>
          ...
          <c:url var="songURL" value="/songs/${reply.originalComment.song.titleForUrl}-${reply.originalComment.song.id}"/>
          <c:url var="artistURL" value="/artists/${reply.originalComment.song.artist.nameForUrl}-${reply.originalComment.song.artist.id}"/>

          <div style="font-weight:bold">Reply to Comment:
            re: <a href="<c:out value="${songURL}"/>"><c:out value="${reply.originalComment.song.title}"/></a>
            by <a href="<c:out value="${artistURL}"/>"><c:out value="${reply.originalComment.song.artist.name}"/></a>
          </div>

          <br>

          <form:form action="comment_reply" name="replyForm" cssClass="cmxform" commandName="reply">
            <c:choose>
