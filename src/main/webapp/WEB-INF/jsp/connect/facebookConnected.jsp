    ...
    <div id="bd">
      ...
      <div id="yui-main">
        ...
        <div class="yui-b"><div class="yui-g">
          ...
          <c:if test="${sessionScope['timelineEnabled'] ne null}">
            <c:set var="timelineEnabled" value="" scope="session"/>
            <h3 style="color:green">Publishing to Timeline enabled!</h3>
            <br><br>
          </c:if>

          <h3>Your Facebook account is connected.</h3>
