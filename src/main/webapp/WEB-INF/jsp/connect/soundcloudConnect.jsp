      ...
      <div id="yui-main">
        ...
        <div class="yui-b"><div class="yui-g">
          ...
          <c:if test="${requestScope['social.addConnection.duplicate'] ne null}">
            <h3 style="color:red">The Soundcloud account you tried to use is already connected to another account.</h3>
            <br><br>
          </c:if>

          <h3>You do not have a Soundcloud account connected to your account.</h3>

          <br><br>

          <form name="soundcloud" action="<c:url value="/connect/soundcloud"/>" method="post">
            <input type="submit" name="submitBtn" value="Connect With Soundcloud!">
          </form>
