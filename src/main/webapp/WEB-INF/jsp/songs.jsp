...
<c:set scope="session" var="songSearch" value="${songSearch}"/>
<html>
  <head>
    <%@ include file="/WEB-INF/jsp/include/head.jsp"%>
    <title><spring:message code="site.name"/>: <c:out value="${songSearch.name}"/>, <c:out value="${songSearch.startResultNum + 1}"/>-<c:out value="${songSearch.startResultNum + fn:length(songSearchResults)}"/></title>
