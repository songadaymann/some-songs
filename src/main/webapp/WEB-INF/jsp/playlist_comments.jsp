...
<c:set var="commentSearch" value="${sessionScope['playlistCommentSearch']}"/>
<c:set var="isReplySearch" value="${sessionScope['isPlaylistReplySearch'] eq 'true'}"/>
    ...
    <div id="bd">
      ...
      <div id="yui-main">
        ...
        <div class="yui-b"><div class="yui-g">
          ...
          <%@ include file="/WEB-INF/jsp/include/playlist_comment_search_list.jsp"%>
      ...
      <%-- show the playlist list right nav if the user is viewing a canned comment search's results --%>
